...
installed = xbmc.translatePath("special://home/addons/service.TeQWinUpdater/installed_version.txt")
latest = xbmc.translatePath("special://home/addons/service.TeQWinUpdater/latest_version.txt")

def path():
	if not os.path.exists(path):
		os.mkdir(path)

url = 'http://teqiqtv.us/Teqiq/TeQ%20IQ%20Update/Win/latest_version.txt'
...
def wizard():
	...
	if choice == 0:
		...
		xbmc.executebuiltin('ActivateWindow(10025,plugin://plugin.program.teqiqwizard/?url=http://teqiqtv.us/Teqiq/TeQ%20IQ%20Update/Win/Win.zip&mode=1&name=UPDATE&iconimage=http://teqiqtv.us/Teqiq/Repo/fanart.jpg)')
